...
unsigned char valor_ch0;
unsigned char valor_ch1;
unsigned char voltaje1;
unsigned char voltaje2;
unsigned char unidad_V1;
unsigned char decima_V1;
unsigned char centesima_V1;
unsigned char unidad_V2;
unsigned char decima_V2;
unsigned char centesima_V2;
...
void ADC_CONV_V(void)
{
  valor_ch0 = ADC_Read(0);
  valor_ch1 = ADC_Read(1);
  voltaje1 = map(valor_ch0, 0, 255, 0, 100);
  voltaje2 = map(valor_ch1, 0, 255, 0, 100);


  unidad_V1 = (voltaje1*5)/100;
  decima_V1 = ((voltaje1*5)/10)%10;
  centesima_V1 = (voltaje1*5)%10;


  unidad_V2 = (voltaje2*5)/100;
  decima_V2 = ((voltaje2*5)/10)%10;
  centesima_V2 = (voltaje2*5)%10;
}
